...
export const GEO_FACT_SCORING_RULES: readonly ScoringRuleDef[] = [
  ...
  { ...base, ruleId: "SR-GF-AUTHOR-DATE", displayName: "저자·날짜 provenance", scoreDomain: "GEO_FACT", category: "Provenance", engineType: "FACT", atomicChecks: ["AC-GF-AUTHOR", "AC-GF-DATE"], maxWeight: 5, evidenceGrade: "C", weightConfidence: "Low", status: "PROVISIONAL_WEIGHT", rationale: "책임 주체와 시점", recommendation: "저자와 작성·수정일을 표시하세요." },
